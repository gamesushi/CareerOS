...
<body style="margin:0;background:#f4f5f7;padding:24px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'PingFang SC','Microsoft YaHei',sans-serif;color:#1a1a1a;">
  <div style="max-width:480px;margin:0 auto;background:#ffffff;border-radius:12px;padding:32px;">
    ...
    <p style="margin:0;font-size:12px;color:#888780;">
      We received a request to reset your uCareerOS password. The link expires in 1 hour. If you didn't request this, you can safely ignore this email.
    </p>
  </div>
</body>
</html>`;
  const text = `重置你的 uCareerOS 密码\n\n我们收到了针对该邮箱的密码重置请求。请打开以下链接设置新密码（1 小时内有效）：\n${resetUrl}\n\n如果不是你本人操作，请忽略此邮件。\n\nWe received a request to reset your uCareerOS password. The link expires in 1 hour: ${resetUrl}`;
...
<body style="margin:0;background:#f4f5f7;padding:24px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'PingFang SC','Microsoft YaHei',sans-serif;color:#1a1a1a;">
  <div style="max-width:480px;margin:0 auto;background:#ffffff;border-radius:12px;padding:32px;">
    ...
    <p style="margin:0 0 16px;font-size:14px;line-height:1.6;color:#444441;">
      感谢注册 uCareerOS！请点击下面的按钮验证你的邮箱，以便启用全部功能。
    </p>
    <p style="margin:0 0 16px;text-align:center;">
    ...
    <hr style="border:none;border-top:1px solid #e6e6e6;margin:24px 0;" />
    <p style="margin:0;font-size:12px;color:#888780;">
      Thanks for signing up for uCareerOS. Verify your email within 24 hours to activate your account: ${verifyUrl}
    </p>
  </div>
</body>
</html>`;
  const text = `验证你的 uCareerOS 邮箱\n\n感谢注册！请打开以下链接完成邮箱验证（24 小时内有效）：\n${verifyUrl}\n\nThanks for signing up. Verify your email within 24 hours: ${verifyUrl}`;
  return { subject, html, text };
}
...
<body style="margin:0;background:#f4f5f7;padding:24px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,'PingFang SC','Microsoft YaHei',sans-serif;color:#1a1a1a;">
  <div style="max-width:480px;margin:0 auto;background:#ffffff;border-radius:12px;padding:32px;">
    ...
    <p style="margin:0 0 16px;font-size:14px;line-height:1.6;color:#444441;">
      以下是你的 uCareerOS 登录验证码，10 分钟内有效。请勿将验证码告知他人。
    </p>
    <p style="margin:0 0 16px;text-align:center;">
    ...
    <hr style="border:none;border-top:1px solid #e6e6e6;margin:24px 0;" />
    <p style="margin:0;font-size:12px;color:#888780;">
      This is your uCareerOS login code. It expires in 10 minutes. If you didn't request it, you can safely ignore this email.
    </p>
  </div>
</body>
</html>`;
  const text = `你的 uCareerOS 登录验证码：${code}（10 分钟内有效）。\n\nThis is your uCareerOS login code: ${code} (valid for 10 minutes).`;
  return { subject, html, text };
}
